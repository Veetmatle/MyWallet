        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitialPrice = table.Column<decimal>(type: "numeric(18,8)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "PortfolioHistories",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PortfolioId = table.Column<int>(type: "integer", nullable: false),
                    TotalValue = table.Column<decimal>(type: "numeric(18,8)", nullable: false),
                    InvestedAmount = table.Column<decimal>(type: "numeric(18,8)", nullable: false),
                    RecordedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PortfolioHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PortfolioHistories_Portfolios_PortfolioId",
                        column: x => x.PortfolioId,
                        principalTable: "Portfolios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssetPriceHistories_Assets_AssetId",
                        column: x => x.AssetId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetPriceHistories_AssetId_RecordedAt",
                table: "AssetPriceHistories",
                columns: new[] { "AssetId", "RecordedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Assets_PortfolioId_Symbol",
                table: "Assets",
                columns: new[] { "PortfolioId", "Symbol" });

            migrationBuilder.CreateIndex(
                name: "IX_PortfolioHistories_PortfolioId_RecordedAt",
                table: "PortfolioHistories",
                columns: new[] { "PortfolioId", "RecordedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ExecutedAt",
                table: "Transactions",
                column: "ExecutedAt");
